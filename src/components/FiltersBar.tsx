...
// export type EventFilterType = "all" | "Kill" | "Loot" | "Killed" | "KilledByStorm";

// const EVENT_FILTERS: EventFilterType[] = ["all", "Kill", "Loot", "Killed", "KilledByStorm"];
...
//       <Select value={selectedDate || undefined} onValueChange={onDateChange}>
...
//       <Select value={selectedMatch || undefined} onValueChange={onMatchChange}>
